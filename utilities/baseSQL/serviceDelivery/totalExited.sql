...
WHERE enrolment.program_name = 'Adolescent'
  ...
  [[ and enrolment.program_exit_date_time >= (q1 || q4 || quote_literal({{ start_date }}) || q4 || q1  ::DATE) ]]
  [[ and enrolment.program_exit_date_time <= q1 || q4 || quote_literal({{ end_date }}) || q4 || q1 ::DATE ]]