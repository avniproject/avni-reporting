...
const hemoglobinReport = new ReportBuilder()
    ...
    .withSubReportWithDenominator("< 7", "hbLessThan7.sql", "totalNonExitedEnrolled.sql")
    .withSubReportWithDenominator("7.1 - 10.0", "hbGreaterThan7LessThan10.sql", "totalNonExitedEnrolled.sql")
    .withSubReportWithDenominator("10.1 - 11.9", "hbGreaterThan10LessThan11.9.sql", "totalNonExitedEnrolled.sql")
    .withSubReportWithDenominator("12", "hbEqualsTo12.sql", "totalNonExitedEnrolled.sql")
    .withSubReportWithDenominator("12.1 - 13.0", "hbGreaterThan12LessThan13.sql", "totalNonExitedEnrolled.sql")
    .withSubReportWithDenominator("> 13", "hbGreaterThan13.sql", "totalNonExitedEnrolled.sql")
    .build();
