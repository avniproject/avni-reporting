...
const educationReport = new ReportBuilder()
    ...
    .withSubReportWithDenominator("Adolescents who discontinued education", "totalAdolescentsDroppedOut.sql", "common/totalNonExitedEnrolled.sql")
...
const menstruationReport = new ReportBuilder()
    ...
    .withSubReportWithDenominator("Menstruation Started", "started.sql", "common/totalNonExitedEnrolled.sql")
    .withSubReportWithDenominator("Menstrual Disorder", "disorder.sql", "common/started.sql")
