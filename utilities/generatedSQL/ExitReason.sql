...
WHERE program_exit_date_time NOTNULL
  AND enrolment.program_name = ''''Adolescent''''
  AND enrolment.program_exit_observations @>
      ''''{"04d33465-0cd3-4755-8329-b057a3d8f707":"9b28db8f-4cbf-4416-834f-3f04bc60eacc"}''''
'', ''SELECT DISTINCT i.uuid              uuid,
                i.gender            gender_name,
                i.addresslevel_type address_type,
                i.addresslevel_name address_name
...
WHERE program_exit_date_time NOTNULL
  AND enrolment.program_name = ''''Adolescent''''
 AND enrolment.program_exit_observations ->> ''''04d33465-0cd3-4755-8329-b057a3d8f707'''' is null
'', ''SELECT DISTINCT i.uuid              uuid,
                i.gender            gender_name,
                i.addresslevel_type address_type,
                i.addresslevel_name address_name
